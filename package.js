...
var packageName = 'webix:skin-touch';  // https://atmospherejs.com/webix/skin-touch
...
Package.describe({
  name: packageName,
  summary: 'Touch skin for Webix UI',
  version: version,
  git: 'https://github.com/MeteorPackaging/webix-skin-touch',
...
Package.onUse(function (api) {
  ...
  api.addFiles(['webix/codebase/skins/debug/touch.css'], 'client');
